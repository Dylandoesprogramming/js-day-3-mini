...
// Code here
var getAgeForAnotherCar = car.getAge.bind(anotherCar,year);
...
var newSound = animal.makeSound.call(dog);
...
var newProp = objWithFind.findProp.call(computer,"nvidia");
console.log(newProp);
/*
...
var filteredObj = objWithFilter.filter.call(objNeedFilter, "soda");
...
var eric = new Person("eric", 24, 120);
console.log(eric);
/*
...
// Code here
  Person.prototype.addWeight = function(addedWeight){
    return this.weight += addedWeight;
  }

  console.log(eric.addWeight(90));
...
// Code here
var brian = new Person("brian",36,150);
var briansClone = new Person("brian's clone",3,100);

brian.addWeight(50);
briansClone.addWeight(80);
console.log(brian);
console.log(briansClone);
